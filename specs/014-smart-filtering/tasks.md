...
- [ ] T001 [P:1.1] Install fzf package: `npm install fzf`
...
- [ ] T002 [P:2.1] Create filter types in `src/renderer/lib/fuzzy-match/types.ts` per data-model.md (FilterQuery, MatchResult, MatchPositions, FilterVisibility)
- [ ] T003 [P:2.1] Create fuzzy matcher wrapper in `src/renderer/lib/fuzzy-match/matcher.ts` using fzf library per research.md
- [ ] T004 [P:2.1] Create tree filtering utilities in `src/renderer/lib/file-tree/filter-utils.ts` (computeNodeVisibility, shouldAutoExpand)
- [ ] T005 [P:2.1] Create persistence utilities in `src/renderer/lib/fuzzy-match/persistence.ts` (getFilterStorageKey, loadFilterQuery, saveFilterQuery with FNV-1a hash)
...
- [ ] T006 [P:2.2] Extend `src/renderer/stores/file-explorer-store.ts` with filter state slice (FileTreeFilterState, FileTreeFilterActions) per data-model.md Section 7
...
- [ ] T007 [P:3.1] [US1] Create `src/renderer/components/file-explorer/FileTreeFilter.tsx` - filter input component with:
...
- [ ] T008 [P:3.1] [US1] Create debounce hook `src/renderer/hooks/useFilterDebounce.ts` - 50ms debounce for filter input per FR-010
...
- [ ] T010 [P:4.1] [US3] Create `src/renderer/components/file-explorer/FilterHighlight.tsx`:
...
- [ ] T012 [P:5.1] [US4] Register filter commands in command registry:
...
- [ ] T013 [P:5.1] [US4] Add filter.focus to command palette in existing command palette component for discoverability (SC-004)
...
- [ ] T014 [P:5.2] [US4] Add focus event listener in FileTreeFilter.tsx:
...
- [ ] T015 [P:6.1] [US5] Implement store persistence actions:
...
- [ ] T016 [P:6.1] [US5] Add project path tracking:
...
- [ ] T018 [P:7.1] Create `src/renderer/lib/fuzzy-match/matcher.test.ts`:
  - Test sequential matching ("mcp" → "MyComponent")
  - Test case insensitivity
  - Test no match returns empty
  - Test positions are correct
- [ ] T019 [P:7.1] Create `src/renderer/components/file-explorer/FileTreeFilter.test.tsx`:
